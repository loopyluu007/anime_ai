...
class _MergedVideoPlayerScreen extends StatefulWidget {
  final File? videoFile; // Web端可能为null
  final String? videoUrl; // Web端使用URL

  const _MergedVideoPlayerScreen({
    this.videoFile,
    this.videoUrl,
  });
    ...
    try {
      if (kIsWeb) {
        ...
        if (widget.videoUrl == null) {
          throw Exception('Web端需要提供videoUrl');
        }
        ...
        if (widget.videoFile == null) {
          throw Exception('移动端需要提供videoFile');
        }
