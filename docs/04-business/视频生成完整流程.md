...
flowchart TD
    ...
    class GenerateDraft,GenerateChar,StartGeneration process
    class CheckIntent,UserConfirm decision
...
graph TB
    ...
    class ChatProvider state
    class DraftController,ScreenplayController logic
