...
4. [数据库配置](#数据库配置)
5. [API 实现](#api-实现)
6. [第三方 API 集成](#第三方-api-集成)
7. [WebSocket 实现](#websocket-实现)
8. [部署配置](#部署配置)
9. [测试方案](#测试方案)
...
本项目为新部署，使用单一的初始迁移文件。`001_initial.sql` 包含所有表结构、索引和约束，适用于新部署场景。
